...
import DYUserData from "./../DYUserData/DYUserData"
import { goToNavigation } from './../../utils/tools';
const home = goToNavigation('/');
const category = goToNavigation('category');
const cart = goToNavigation('cart');
const other = goToNavigation('other');
const dy = goToNavigation('dy');
const NavBar = ({ sectionId, env, recommendationContext }) => {
          ...
          <Nav className="justify-content-end flex-grow-1 pe-3">
            ...
            <Nav.Item>
              <Link
                ...
                to={dy}
                onClick={() => setExpand(false)}>
                  <span className="nav-link-label">DY</span>
                </Link>
            </Nav.Item>
